...
function terminal_colour(){
    ...
    if [[ $1 == "--help" ]]; then
        ...
        echo "Pride/Id:   --bi --trans --bi-old --ancom --gay --pride"
        echo "=================================="
    elif [[ $1 == "--bi" ]]; then
        ...
        export PS1='${debian_chroot:+($debian_chrooreset}\[\e[0;91m\]\u\[\e[38;5;166m\]@\[\e[0;93m\]\h\[\e[0;92m\]:\[\e[0;94m\]'"$CWD"'\[\e[38;5;56m\]\$\[\033[01;00m\] '
    elif [[ $1 == "--gay" ]]; then
